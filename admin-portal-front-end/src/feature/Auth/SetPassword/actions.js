...
export const setPasswordRequest = formData => async dispatch => {
    try {
        ...
        await api('put', 'admin/auth/set-password', formData);
...
export const checkTokenValidity = formData => async dispatch => {
    try {
        ...
        await api('post', 'admin/auth/check-password-token-validity', formData);
...
export const renewToken = formData => async dispatch => {
    try {
        ...
        await api('put', 'admin/auth/renew-password-token', formData);
